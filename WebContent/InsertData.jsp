...
try{
    ...
    response.getWriter().write("<script>alert('添加成功');location.href='listTable.jsp'</script>");
}catch(SQLException e){
	response.getWriter().write("<script>alert('添加失败1');location.href='listTable.jsp'</script>");
    e.printStackTrace();
}catch (Exception e) {
	response.getWriter().write("<script>alert('添加失败2');location.href='listTable.jsp'</script>");
    e.printStackTrace();
}
